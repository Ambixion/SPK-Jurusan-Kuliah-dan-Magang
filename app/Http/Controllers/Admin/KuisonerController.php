...
class KuisonerController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.kuisoner.create', compact('jurusans', 'bidangs', 'skills', 'kriterias'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.kuisoner.edit', compact('kuisoner', 'jurusans', 'bidangs', 'skills', 'kriterias'));
    }
