...
<div class="card-main">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
        <div class="card-title" style="margin-bottom:0;">Preferensi Lingkungan</div>
    ...
    <form action="{{ route('siswa.jurusan.store') }}" method="POST" id="formStep">
        ...
        <div style="display:flex;justify-content:space-between;margin-top:20px;">
            <a href="{{ route('siswa.jurusan.step2') }}"
               style="background:rgba(255,255,255,0.1);color:#fff;padding:11px 26px;border-radius:50px;font-size:13px;font-weight:700;text-decoration:none;border:1px solid rgba(255,255,255,0.2);">
                ← Kembali
            </a>
            <button type="submit" class="btn-primary-spk">Selesai & Lihat Hasil →</button>
        </div>
    </form>
</div>
