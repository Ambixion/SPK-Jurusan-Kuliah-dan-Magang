            ...
            <div>
                ...
                <nav class="menu">
                    ...
                    <a href="{{ route('guru.siswa.index') }}"
                        class="menu-item {{ request()->routeIs('guru.siswa.*') ? 'active' : '' }}">
                        <div class="menu-icon icon-red">👔</div>
                        <span>Data Siswa</span>
                    </a>

                    <a href="{{ route('guru.tempat_magang') }}"
                        class="menu-item {{ request()->routeIs('guru.tempat_magang') ? 'active' : '' }}">
                        <div class="menu-icon icon-purple">🏢</div>
                        <span>Data Pemilihan PKL</span>
                    </a>

                    <a href="{{ route('guru.jurusan_kuliah') }}"
                        class="menu-item {{ request()->routeIs('guru.jurusan_kuliah') ? 'active' : '' }}">
        ...
        <div class="modal-card">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-form-grid">
                    <div class="form-group">
                        <label>Nama Siswa</label>
                        <input type="text" name="nama" id="editNama" placeholder="Masukkan nama siswa"
                            required>
                    </div>

                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" name="email" id="editEmail" placeholder="Masukkan email siswa"
                            required>
                    </div>
